<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $eventRegistrant->ticket_number],
                ['confirm' => __('Are you sure you want to delete # {0}?', $eventRegistrant->ticket_number)]
            )
        ?></li>
...
<div class="eventRegistrants form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Event Registrant') ?></legend>
        <?php
